...
func file_telemetry_events_pmm_server_uptime_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_telemetry_events_pmm_server_uptime_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_telemetry_events_pmm_server_uptime_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_telemetry_events_pmm_server_uptime_event_proto_msgTypes[2].Exporter = func(v any, i int) any {
