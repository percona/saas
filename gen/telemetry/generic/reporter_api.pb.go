...
func file_telemetry_generic_reporter_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_telemetry_generic_reporter_api_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_telemetry_generic_reporter_api_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_telemetry_generic_reporter_api_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_telemetry_generic_reporter_api_proto_msgTypes[3].Exporter = func(v any, i int) any {
