...
func file_telemetry_reporter_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_telemetry_reporter_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_telemetry_reporter_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Event); i {
			case 0:
				return &v.state
			case 1:
